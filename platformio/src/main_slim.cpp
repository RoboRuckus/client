...
class Robot {
    public:
        ...
        virtual void playerAssigned(int player) {}

        virtual void turn (int direction, int magnitude) {}

        virtual void driveForward(int magnitude) {}
        /// @brief 
        /// @param Magnitude 
        virtual void driveBackward(int Magnitude) {}
        
        /// @brief 
        /// @param direction 
        /// @param magnitude 
        virtual void lateralMove(int direction, int magnitude) {}
